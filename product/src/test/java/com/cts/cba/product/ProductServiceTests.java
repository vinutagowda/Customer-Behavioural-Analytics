...
public class ProductServiceTests {
    ...
    public void getProductSoldTest() {
        ...
        when(repo.findAllByDuration(timeDuration, customerCategory)).thenReturn(Stream
                .of(new Product(1176, "Sugar", "Food & Beverages", "NSF", "Good", 74.69, 50,
    ...
    public void getAllProductByPriceRangeTest() {
        ...
        double endPrice = 200;
        when(repo.findAllByPriceRange(timeDuration, customerCategory, startPrice, endPrice)).thenReturn(Stream
                .of(new Product(1125, "pen", "Home & LifeStyle", "Pavithra brite", "Average", 72.61, 5,
                        Sets.newSet(new Discount(1, "No Discount", "Zero perc discount", 0))))
                .collect(Collectors.toList()));
    ...
    public void getAllProductByDiscountTest() {
        ...
        when(repo.findAllByDiscount(timeDuration, customerCategory)).thenReturn(Stream
                .of(new Product(1117, "Watch", "Accessories", "Titan", "Average", 73.56, 10,
                        Sets.newSet(new Discount(1, "No Discount", "Zero perc discount", 0))))
                .collect(Collectors.toList()));
    ...
    public void getAllProductByCategoryTest() {
        ...
        when(repo.findAllByCategory(timeDuration, customerCategory, category)).thenReturn(Stream
                .of(new Product(1123, "Coffee Powder", "Food & Beverages", "Cothas", "Average", 93.72, 5,
                        Sets.newSet(new Discount(1, "No Discount", "Zero perc discount", 0))))
                .collect(Collectors.toList()));
    ...
    public void getAllProductByBrandTest() {
        ...
        when(repo.findAllByBrand(timeDuration, customerCategory, brand)).thenReturn(Stream
                .of(new Product(1111, "Coffee powder", "Food & Beverages", "Nescafe", "Good", 74.69, 50,
                        Sets.newSet(new Discount(1, "No Discount", "Zero perc discount", 0))))
                .collect(Collectors.toList()));
